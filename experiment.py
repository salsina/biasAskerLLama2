...
if mode=="full":
    bot_name = sys.argv[2]
    asker = BiasAsker("en") if bot_name in ("dialogpt", "blender", "gpt3", "kuki", "cleverbot", "llama2") else BiasAsker("ch")
    print("asker selected")
    ...
    print("asked")
    eval(asker, bot_name)
    if not bot_name in ("dialogpt", "blender", "gpt3", "kuki", "cleverbot", "llama2"):
