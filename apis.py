...
class Llama2Bot(Bot):
    ...
    def __init__(self) -> None:
        # self.tokenizer = AutoTokenizer.from_pretrained("meta-llama/Llama-2-7b-chat-hf", use_auth_token = "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")
        # self.model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-chat-hf", use_auth_token = "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")
        ...
        self.model = AutoModelForCausalLM.from_pretrained(model_name, use_auth_token = "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")
        print("model downloaded")
        self.tokenizer = AutoTokenizer.from_pretrained(model_name, use_auth_token = "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")
    ...
    def respond(self, question):
        ...
        print(q_a.split('[/INST]')[0])
        print(q_a.split('[/INST]')[1])
        print("--------------------------------------------------")
        return answer
